                    ...
                    <td class="border border-black px-2 py-1 w-3/4 text-xs">
                        ...
                        <select name="plan_start_hour" id="plan_start_hour">
                            @for ($i = 0; $i <= 23; $i++)
                                ...
                                <option value="{{ $planStartHour }}" @if (old('plan_start_hour') == $planStartHour) selected @endif>
                                    {{ $planStartHour }}</option>
                        ...
                        <select name="plan_end_hour" id="plan_end_hour">
                            @for ($i = 0; $i <= 23; $i++)
                                ...
                                <option value="{{ $planEndHour }}" @if (old('plan_end_hour') == $planEndHour) selected @endif>
                                    {{ $planEndHour }}</option>
                            @endfor
                        ...
                        <select name="plan_end_minute" id="plan_end_minute">
                            @for ($i = 0; $i <= 45; $i += 15)
                                ...
                                <option value="{{ $planEndMinute }}" @if (old('plan_end_minute') == $planEndMinute) selected @endif>
                                    {{ $planEndMinute }}</option>
                            @endfor
