    ...
    <body>
        <div class="container w-7/11 mx-auto text-base">
            ...
            <div class="mt-6 flex justify-center gap-3">
                <form action="{{ route('overtime_sheets.update', $overtimeSheet->overtimeRequest->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <x-ui.button message="更新する" class="bg-green-600 hover:bg-green-700 py-1 px-2"/>
                </form>
            </div>
        </div>
    </body>
